  ...
  const content = `
    <table width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td>
          <p style="margin:0 0 28px;font-size:15px;line-height:1.6;color:#475569;">
            Cảm ơn bạn đã báo cáo nội dung vào ngày ${escapeHtml(reportDate)}. Sau khi đội ngũ quản trị xem xét, chúng tôi xác nhận nội dung này đã <strong>vi phạm quy định</strong> của Quik.
          </p>
        </td>
      </tr>
      <tr>
